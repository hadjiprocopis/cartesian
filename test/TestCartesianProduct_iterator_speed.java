...
public	class	TestCartesianProduct_iterator_speed {
	public static void main(String[] args){
		...
		try {
			...
			System.out.print("TestCartesianProduct_iterator_speed : testing speed for dims: "+Arrays.toString(dims)+" with the spec: "+Arrays.toString(specs)+" :");
			...
			num_items--;
			System.out.println("\nTestCartesianProduct_iterator_speed.java : produced "+num_items+" items.");
		} catch(Exception ex){ System.err.println("TestCartesianProduct_iterator_speed.java : exception was caught:\n"+ex); ex.printStackTrace(); System.exit(1); }
		System.out.println("TestCartesianProduct_iterator_speed.java : main() : time taken: "+((System.nanoTime()-time_started)/1000000)+" milli seconds.");
	}
}
